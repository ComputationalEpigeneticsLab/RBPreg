      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          <li><a href="index.jsp">Home</a></li>
 		  <li class="active"><a href="example.jsp">Tutorials</a></li>
...
<!--           										<th>HighAnnot</th> -->
          		...
          		<div id="scenic_heatmap_all" class="layui-tab layui-tab-card" >
					...
					<div class="layui-tab-content" style="height:">
						<div id="" class="layui-tab-item layui-show">
							<div id="Scenic_CancerHallmark_plot"></div>
						</div>
						<div id="" class="layui-tab-item ">
							<div id="Scenic_imm_plot"></div>
						</div>
					</div>
				</div>
          	</div>
...
$.getJSON("example/example.txt", "", function(data) {
//console.log(data);
	...
	if(data.error_attention=="no"){
		...
		document.getElementById("select_JobId").innerHTML=data.JobId;
...
////heatmap all
//heatmao cancerhallmark
// 	var heatmap_min=Number(data.Reglon_pathway_cancerhallmark_min);
// 	var heatmap_max=Number(data.Reglon_pathway_cancerhallmark_max);
// 	var heatmap_x=data.Reglon_pathway_cancerhallmark_x.split(",");
// 	var heatmap_y=data.Reglon_pathway_cancerhallmark_y.split(",");
// 	var heatmap_data=data.Reglon_pathway_cancerhallmark_value.split(";");
// 	var heatmap_data_valuearray = [];				
// 		for (var i=0;i<heatmap_data.length;i++)
// 		{ 
// 			var a=heatmap_data[i].split(",");
// 			var b=[];
// 			for (var j=0;j<a.length;j++){
// 				b.push(Number(a[j]));
// 			}					
// 			heatmap_data_valuearray.push(b);
// 		}
// 		echars_Heatmap_cancerhallmark(heatmap_x,heatmap_y,heatmap_data_valuearray,heatmap_min,heatmap_max);	
//scatter hallmark
...
//heatmap imm
// 	var heatmap_min=Number(data.Reglon_pathway_imm_min);
// 	var heatmap_max=Number(data.Reglon_pathway_imm_max);
// 	var heatmap_x=data.Reglon_pathway_imm_x.split(",");
// 	var heatmap_y=data.Reglon_pathway_imm_y.split(",");
// 	var heatmap_data=data.Reglon_pathway_imm_value.split(";");
// 	var heatmap_data_valuearray = [];				
// 		for (var i=0;i<heatmap_data.length;i++)
// 		{ 
// 			var a=heatmap_data[i].split(",");
...
// 			heatmap_data_valuearray.push(b);
// 		}
// 		echars_Heatmap_imm(heatmap_x,heatmap_y,heatmap_data_valuearray,heatmap_min,heatmap_max);	
...
var data_option=data.Regulons.split(",");
		...
		for (var i=0;i<data_option.length;i++)
					...
					var demo1_gene = xmSelect.render({
						...
						//change gene back to upload re
// 							document.getElementById('single_table').setAttribute("class","layui-this");						
// 							document.getElementById('single_circos').setAttribute("class","");
// 							document.getElementById('single_tsen').setAttribute("class","");
// 							document.getElementById('single_re_table').setAttribute("class","layui-tab-item layui-show");	
// 							document.getElementById('single_re_circos').setAttribute("class","layui-tab-item layui");
// 							document.getElementById('single_re_tsen').setAttribute("class","layui-tab-item layui");
						//reload table
