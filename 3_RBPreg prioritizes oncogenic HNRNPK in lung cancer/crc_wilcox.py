...
dir="/bioXJ/zhouww/SCENIC/scRNA/4_cancer_gene_wilcox/crc/"
dir1="/bioXJ/zhouww/SCENIC/scRNA/4_cancer_jt/4_cancer_exp_mat_org/"
bc=pd.read_csv(dir1+"crc_matrix_org.txt",header=0,sep="\t")
bc_celltype=pd.read_csv(dir1+"CRC_metadata.csv",header=0)
...
bc_mannwhitneyu_re.to_csv(dir+"crc_mannwhitneyu_re.txt",header=True,sep="\t",index=False)